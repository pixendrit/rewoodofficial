          ...
          <Row className="align-items-center justify-content-center">
            ...
            >
              <div className="team-widget media">
                <Link to="/#" className="widget-img mr-7">
            ...
            >
              <div className="team-widget media">
                ...
                <div className="widget-text">
                  <Link to="/#">
                    <h3 className="name gr-text-7 mb-6">Dr. Nannie Roberts</h3>
                  </Link>
                  <p className="gr-text-11 mb-0">
                    MBBS, MD (Cardiology) <br />
                    Senior Consultant
            ...
            >
              <div className="team-widget media">
                ...
                <div className="widget-text">
                  <Link to="/#">
                    <h3 className="name gr-text-7 mb-6">Dr. Hannah Stanley</h3>
                  </Link>
                  <p className="gr-text-11 mb-0">
                    MBBS, MD (Cardiology) <br />
                    Senior Consultant
            ...
            >
              <div className="team-widget media">
                ...
                <div className="widget-text">
                  <Link to="/#">
                    <h3 className="name gr-text-7 mb-6">Dr. Roger McDonald</h3>
                  </Link>
                  <p className="gr-text-11 mb-0">
                    MBBS, MD (Cardiology) <br />
                    Senior Consultant
