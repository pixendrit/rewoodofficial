              ...
              {items.map(
                (
                  ...
                  <div key={index}>
                    <Link
                      to={link}
                      className="feature-widget focus-reset bg-white d-flex flex-column min-height-px-297 border rounded-10 pt-8 pb-8 pl-7 mx-6 pl-lg-9 pr-md-8 pr-lg-10 gr-hover-shadow-1"
                    >
